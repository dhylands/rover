...
ifeq ($(ARDUINO),)
$(error Plese define ARDUINO make variable)
endif
...
# path location for personal libraries
LIBRARY_PARENT = ..
LIBRARY_PATH = $(LIBRARY_PARENT)/libraries

# path location for arduino libraries
ARDUINO_LIBS_PARENT = $(ARDUINO)
ARDUINO_LIBS_PATH = $(ARDUINO_LIBS_PARENT)/libraries
...
vpath %.c   $(LIBRARY_PARENT) $(ARDUINO_LIBS_PARENT) $(CORE_PARENT)
vpath %.cpp $(LIBRARY_PARENT) $(ARDUINO_LIBS_PARENT) $(CORE_PARENT)
...
LC_FILES +=   $(patsubst $(ARDUINO_LIBS_PARENT)/%,%,$(foreach lib,$(ARDUINO_LIBS),$(wildcard $(ARDUINO_LIBS_PATH)/$(lib)/*.c)))
LCPP_FILES += $(patsubst $(ARDUINO_LIBS_PARENT)/%,%,$(foreach lib,$(ARDUINO_LIBS),$(wildcard $(ARDUINO_LIBS_PATH)/$(lib)/*.cpp)))

# include paths for libraries
L_INC := $(foreach lib,$(filter %/, $(wildcard $(LIBRARY_PATH)/*/)), -I$(lib))
L_INC += $(foreach lib,$(ARDUINO_LIBS),-I$(ARDUINO_LIBS_PATH)/$(lib))
